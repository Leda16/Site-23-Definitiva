    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="textLogin.php" method="POST" class="sign-in-form">
          ...
          <form action="landpage.php" method="POST" class="sign-up-form">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          ...
          <img src="img/land-logo.png" class="image" alt="" />
        </div>
